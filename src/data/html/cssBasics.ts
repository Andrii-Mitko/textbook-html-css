...
p {
  ...
  {
    id: "css-text-indent",
    title: "Червоний рядок тексту в CSS",
    description:
    ...
    content: [
      {
        type: "heading",
        text: "Червоний рядок тексту в CSS",
      },

      {
        type: "paragraph",
        text: "У текстових документах червоний рядок — це відступ першого рядка абзацу. У CSS такий ефект створюється за допомогою властивості text-indent.",
      },

      {
        type: "paragraph",
        text: "Властивість text-indent задає відступ першого рядка тексту. Значення зазвичай вказується у пікселях (px).",
      },
...
<p>
  ...
  width: 400px;
      ...
      {
        type: "paragraph",
        text: "У цьому прикладі кожен абзац отримує відступ першого рядка на 50px.",
      },
      ...
      {
        type: "note",
        text: "Властивість text-indent застосовується до блочних елементів із текстом, найчастіше до абзаців p.",
      },

      {
        type: "warning",
        text: "Не плутайте text-indent з padding або margin. text-indent змінює тільки перший рядок тексту, а не весь блок.",
      },

      {
        type: "task",
        text: [
          "Створіть на сторінці декілька абзаців із текстом.",
          "Додайте CSS властивість text-indent.",
          "Встановіть відступ першого рядка 50px.",
          "Перевірте результат у браузері.",
        ],
      },
      ...
      {
        type: "hint",
        text: "Використайте селектор p та властивість text-indent зі значенням у пікселях.",
      },
  ...
  },
  {
    ...
    content: [
      {
        type: "heading",
        text: "Ефекти тексту в CSS",
      },

      {
        type: "paragraph",
        text: "Властивість text-decoration використовується для додавання різних ефектів до тексту: підкреслення, перекреслення, лінії зверху, а також для скасування таких ефектів.",
      },

      {
        type: "paragraph",
        text: "Найчастіше ця властивість використовується для скасування підкреслення посилань, оскільки браузери за замовчуванням показують посилання з нижньою лінією.",
      },
  ...
  text-decoration: none;
      ...
      {
        type: "paragraph",
        text: "У цьому прикладі підкреслення у посилань буде прибране.",
      },

      {
        ...
        headers: ["Значення", "Опис"],
        rows: [
          ["underline", "Додає підкреслення тексту"],
          ["overline", "Додає лінію над текстом"],
          ["line-through", "Перекреслює текст"],
          ["none", "Прибирає всі ефекти тексту"],
        ],
      },

      {
        type: "note",
        text: "У наступних уроках ми детально розглянемо кожне значення властивості text-decoration.",
      },

      {
        type: "task",
        text: [
          "Створіть кілька текстових елементів на сторінці.",
          "Перевірте роботу різних значень text-decoration.",
          "Спробуйте застосувати властивість до абзаців та посилань.",
        ],
      },

      {
        type: "hint",
        text: "Для посилань використовуйте text-decoration: none;, щоб прибрати стандартне підкреслення браузера.",
      },
    ],
  },
  {
    id: "css-text-decoration-underline",
    title: "Нижнє підкреслення тексту в CSS",
    description:
    ...
    content: [
      {
        type: "heading",
        text: "Нижнє підкреслення тексту в CSS",
      },

      {
        type: "paragraph",
        text: "Значення underline властивості text-decoration додає лінію під текстом.",
      },

      {
        type: "paragraph",
        text: "Цей ефект часто використовується для виділення важливої інформації або створення стилю для окремих елементів сторінки.",
      },
  ...
  text-decoration: underline;
      ...
      {
        type: "paragraph",
        text: "Після застосування стилю текст у всіх абзацах p буде мати нижнє підкреслення.",
      },

      {
        type: "table",
        headers: ["Властивість", "Значення", "Результат"],
        rows: [["text-decoration", "underline", "Підкреслення тексту знизу"]],
      },

      {
        type: "note",
        text: "За допомогою text-decoration можна керувати декоративними лініями тексту без зміни HTML структури.",
      },

      {
        type: "task",
        text: [
          "Створіть абзац із будь-яким текстом.",
          "Додайте CSS властивість text-decoration.",
          "Встановіть значення underline.",
          "Перевірте результат у браузері.",
        ],
      },
      ...
      {
        type: "hint",
        text: "Використайте селектор p та запис: text-decoration: underline;",
      },
  ...
  },
  {
    ...
    title: "Верхнє підкреслення тексту в CSS",
    description:
    ...
    content: [
      {
        type: "paragraph",
        text: "Значення overline додає лінію над текстом. Цей ефект створюється за допомогою властивості text-decoration.",
      },
  ...
  text-decoration: overline;
      ...
      {
        type: "paragraph",
        text: "Після застосування стилю над текстом абзацу з'явиться горизонтальна лінія.",
      },

      {
        type: "task",
        text: [
          "Повторіть приклад, наведений вище.",
          "Створіть абзац з власним текстом.",
          "Додайте йому верхнє підкреслення за допомогою text-decoration: overline.",
        ],
      },
...

  {
    ...
    title: "Перекреслення тексту в CSS",
    description:
    ...
    content: [
      {
        type: "paragraph",
        text: "Значення line-through властивості text-decoration додає горизонтальну лінію через текст. Цей ефект використовується, наприклад, для позначення видаленого або неактуального тексту.",
      },
  ...
  text-decoration: line-through;
      ...
      {
        type: "paragraph",
        text: "Після застосування стилю текст абзацу буде перекреслений лінією.",
      },

      {
        ...
        text: [
          "Повторіть приклад, наведений вище.",
          "Створіть власний абзац і застосуйте до нього перекреслення тексту за допомогою text-decoration: line-through.",
        ],
      },
  ...
  },
  {
    ...
    title: "Скасування ефектів для тексту в CSS",
    description:
    ...
    content: [
      {
        type: "paragraph",
        text: "За замовчуванням посилання в HTML мають підкреслення. За допомогою властивості text-decoration зі значенням none можна прибрати цей ефект.",
      },
  ...
  text-decoration: none;
      ...
      {
        type: "paragraph",
        text: "Після застосування стилю посилання буде відображатися без підкреслення.",
      },

      {
        type: "task",
        text: [
          "Реалізуйте приклад, наведений вище.",
          "Створіть посилання та приберіть його стандартне підкреслення за допомогою CSS.",
        ],
      },
  ...
  },
  {
    ...
    title: "Практика на основні CSS властивості",
    description:
    ...
    content: [
      {
        type: "paragraph",
        text: "Скопіюйте наступний HTML код собі на сторінку та додайте до нього CSS стилі.",
      },
...
<ul>
  ...
  <li>
    Скрипты, которые выполняются в браузере.
    Это JavaScript.
  </li>
</ul>`,
      },

      {
        type: "task",
        text: [
          "Додайте до цього коду CSS стилі, щоб отримати потрібний результат.",
          "Оформіть заголовки, абзаци, списки та виділений текст.",
        ],
      },

      {
        type: "hint",
        text: "Спробуйте використати властивості, які ви вже вивчили: color, font-size, font-family, font-weight, font-style, text-align, text-decoration, text-indent.",
      },
